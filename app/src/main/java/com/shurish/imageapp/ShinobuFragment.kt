...
import com.shurish.imageapp.databinding.FragmentShinobuBinding
...
class ShinobuFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding  = FragmentShinobuBinding.inflate(layoutInflater)
    ...
    private fun fetchImages() {
        ApiClient.apiService.getShinobuImage().enqueue(object : Callback<ImageResponse> {
